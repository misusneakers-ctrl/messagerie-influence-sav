...
// Correctif 2026-09-17 : passe par lib/shopify/readonly-token.js, qui accepte
// aussi bien l'ancien jeton permanent (`shpat_...`, posé à la main le 11/09)
// que le jeton OAuth expirant obtenu par la reconnexion avec
// `read_all_orders` — et le rafraîchit tout seul le cas échéant.
async function loadShopifyReadonlyToken(tenant) {
  return getReadonlyAccessToken(tenant);
}
